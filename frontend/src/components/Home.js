            ...
            <Grid item xs={12} md={6}>
              <ContentBox>
                ...
                <Typography variant="body1" paragraph>
                  Access professional-grade tools without the hefty investment. Our lending library 
                  makes it possible for everyone to tackle their DIY dreams, home improvements, 
                  and creative projects with the right equipment.
                </Typography>
          ...
          <Grid container spacing={6} alignItems="center" direction="row-reverse">
            ...
            <Grid item xs={12} md={6}>
              <ContentBox>
                ...
                <Typography variant="body1" paragraph>
                  Join a network of makers, creators, and DIY enthusiasts. Share knowledge, 
                  exchange tips, and collaborate on projects. Our platform isn't just about 
                  tools—it's about building connections.
                </Typography>
                <Button variant="outlined" color="primary" size="large">
                  Join Now
                </Button>
          ...
          <Grid container spacing={6} alignItems="center">
            ...
            <Grid item xs={12} md={6}>
              <ContentBox>
                ...
                <Typography variant="body1" paragraph>
                  By sharing resources, we reduce waste and environmental impact. One quality 
                  tool shared among many is better than many tools sitting idle. Join us in 
      ...
      <ContentSection sx={{ backgroundColor: 'primary.main', color: 'white' }}>
        <Container maxWidth="md" sx={{ textAlign: 'center' }}>
          ...
          <Typography variant="h6" paragraph sx={{ mb: 4 }}>
            Join our community today and start borrowing tools for your next project.
          </Typography>
          <Button 
            variant="contained" 
            color="secondary" 
