"""Remove tool_returns table

Revision ID: c430e87f20c4
Revises: cd5174d25e8b
Create Date: 2024-12-02 22:29:23.898107
...
revision: str = 'c430e87f20c4'
down_revision: Union[str, None] = 'cd5174d25e8b'
...
def downgrade() -> None:
    ...
    sa.Column('return_pending', sa.BOOLEAN(), nullable=True),
